...
(let ((handmade-beige "burlywood3")
      ...
      (handmade-light-gray2 "#282828")
      (handmade-light-green "#40ff40")
      (handmade-olive "olive drab")
      (handmade-red "Red")
      (handmade-orange "#fe8019")
      (handmade-yellow "Yellow"))
  (custom-theme-set-faces
   'handmade
   `(cursor ((t (:background ,handmade-olive))))
   ...
   `(font-lock-function-name-face ((t (:foreground ,handmade-orange))))
   `(font-lock-keyword-face ((t (:foreground ,handmade-gold))))
   `(font-lock-string-face ((t (:foreground ,handmade-olive))))
   `(font-lock-type-face ((t (:foreground ,handmade-gold))))
   ...
   `(region ((t (:background, handmade-light-gray2))))
   `(link ((t (:foreground, handmade-olive))))
   `(hl-line ((t (:background ,handmade-light-gray2))))))
